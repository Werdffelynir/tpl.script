...
Tpl.domLoaded(function(){
    ...
    Tpl.include('demo_page.html', function(response){

        var outputData = {
            title: 'Simple text title',
            description: 'Simple content description'
        };

        var objHeaderResponse = Tpl.inject('#demo_page', response, outputData);
